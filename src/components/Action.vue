    ...
    <div>
        ...
        <div class="accordion" id="accordion">
            <div v-for="data in myJson.actions">
                ...
                <div v-if="$route.query.method == data.method && $route.query.path == data.path.path" class="accordion-item">
                                        ...
                                        <div class="accordion-item">
                                            ...
                                            <div class="accordion-item-body" style="margin-left:300px;">
                                                ...
                                                <div v-for="error in combination['error']">
                                                    <p>
                                                        <vue-json-compare :oldData="error.test" :newData="error.test"></vue-json-compare>
                                                    </p>
                                                    <p>
                                                        <vue-json-compare :oldData="error.error" :newData="error.error"></vue-json-compare>
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
